                    ...
                    {events.length === 0 ? (
                        ...
                        <AnimatePresence>
                            {events.map((evt, idx) => (
                                ...
                                >
                                    <Card className={`p-3 backdrop-blur-md text-sm transition-all duration-300 ${evt.safe
                                        ...
                                        <div className="flex items-start justify-between mb-3">
                                            ...
                                            <Badge variant={evt.safe ? 'outline' : 'destructive'} className={`text-[9px] uppercase tracking-widest ${evt.safe ? 'border-emerald-500/50 text-emerald-400' : 'bg-red-500 text-white shadow-[0_0_10px_rgba(239,68,68,0.6)]'}`}>
                                                {evt.risk_level} risk
                                            </Badge>
                                        </div>
